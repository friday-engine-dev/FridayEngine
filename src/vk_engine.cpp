...
void VulkanEngine::init_default_data()
{
    ...
    _errorCheckerboardImage = create_image(pixels.data(), VkExtent3D{ 16, 15, 1 }, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_SAMPLED_BIT);
...
void VulkanEngine::cleanup()
{
    if (_isInitialized)
    {
        //make sure that the gpu has stopped
...
{
    //wait until GPU is finished rendering
...
void VulkanEngine::run()
{
    ...
    while (!bQuit)
    {
        ...
        {
            ImGui::SliderFloat("RenderScale", &renderScale, 0.3f, 1.f);
...
void VulkanEngine::init_swapchain()
{
    ...
    drawImageUsages |= VK_BUFFER_USAGE_TRANSFER_SRC_BIT;
